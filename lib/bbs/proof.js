...
export function ProofChallengeCalculate({
  ...
  */
  ...
  -----
  Note: Draft 5 put `Abar, Bbar, D, T1, T2` before `R` and put the indexes
  all together in a row before the messages all together in a row:
  c_arr = (Abar, Bbar, D, T1, T2, R, i1, ..., iR,
